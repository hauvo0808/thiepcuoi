...
const CONFIG = {
  ...
  WEDDING_DATE: new Date('2026-06-15T17:30:00'),

  // Gold particle colour palette
  PARTICLE_COLORS: [
    'rgba(239, 217, 78,  0.80)',  // bright vintage gold
    'rgba(201, 162, 39,  0.65)',  // deep gold
    'rgba(247, 235, 184, 0.55)',  // pale gold shimmer
    'rgba(239, 217, 78,  0.35)',  // faint gold dust
    'rgba(255, 248, 210, 0.50)',  // near-white glint
  ],
...
function initParticles() {
  ...
  /**
   * Draw one particle — small rhombus / diamond shape
   * Gives a more "fleck of gold leaf" feel than a circle.
   */
   ...
   *
   * Particles drift slowly upward with a horizontal sway,
   * giving an ambient floating-dust-in-candlelight effect.
   */
  function spawnParticle(atBottom) {
    return {
      ...
      speedY:     -(Math.random() * 0.5 + 0.15),   // drift upward
      speedX:     (Math.random() - 0.5) * 0.3,
      rotation:   Math.random() * Math.PI * 2,
      rotSpeed:   (Math.random() - 0.5) * 0.022,
      opacity:    Math.random() * 0.55 + 0.15,
      swayAmp:    Math.random() * 0.018 + 0.004,
